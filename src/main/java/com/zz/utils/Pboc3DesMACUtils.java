...
public class Pboc3DesMACUtils {
    ...
    public static byte[] calculatePboc3desMAC(byte[] data, byte[] key, byte[] icv) throws Exception {
        ...
        byte[] desXor = DESUtil.xOr(dataBlock[0], icv);
        for (int i = 1; i < blockCount; i++) {
            byte[] des = DESUtil.encryptByDesCbc(desXor, leftKey);
            desXor = DESUtil.xOr(dataBlock[i], des);
        }
        desXor = DESUtil.encryptBy3DesCbc(desXor, key);
        return desXor;
    }

    public static void main(String[] args) throws Exception {
        String macKey = "3264F341FCA74C57608D594DE7F12F05";
        String data = "DF3679BA3DE3E9535D9FE7F2CED7131878E6543280000000";
